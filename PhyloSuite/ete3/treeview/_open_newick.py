...
class Ui_OpenNewick(object):
    def setupUi(self, OpenNewick):
        ...
        OpenNewick.setWindowTitle("OpenNewick")
        self.comboBox = QComboBox(OpenNewick)
        self.comboBox.setGeometry(QtCore.QRect(460, 300, 81, 23))
        self.comboBox.setObjectName("comboBox")
        self.widget = QWidget(OpenNewick)
    ...
    #     OpenNewick.setWindowTitle(QApplication.translate("OpenNewick", "Dialog", None, QApplication.UnicodeUTF8))
