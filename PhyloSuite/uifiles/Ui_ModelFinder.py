...
# Form implementation generated from reading ui file 'ModelFinder.ui'
#
...
class Ui_ModelFinder(object):
    ...
    def retranslateUi(self, ModelFinder):
        ...
        self.comboBox_5.setItemText(1, _translate("ModelFinder", "PAML"))
        self.comboBox_5.setItemText(2, _translate("ModelFinder", "Mrbayes"))
        self.comboBox_5.setItemText(3, _translate("ModelFinder", "RAxML"))
        self.comboBox_5.setItemText(4, _translate("ModelFinder", "PhyML"))
        self.comboBox_5.setItemText(5, _translate("ModelFinder", "BEAST1 (NUC)"))
        self.comboBox_5.setItemText(6, _translate("ModelFinder", "BEAST2 (NUC)"))
        self.comboBox_5.setItemText(7, _translate("ModelFinder", "BEAST (AA)"))
        self.comboBox_5.setItemText(8, _translate("ModelFinder", "FastTree (AA)"))
