...
# Form implementation generated from reading ui file 'E:\F\Work\python\bioinfo_excercise\PhyloSuite\codes\PhyloSuite_gitee\PhyloSuite\uifiles\ModelFinder.ui'
#
...
class Ui_ModelFinder(object):
    def setupUi(self, ModelFinder):
        ...
        ModelFinder.resize(1167, 570)
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(ModelFinder)
        ...
        self.checkBox_2.toggled['bool'].connect(self.spinBox_2.setEnabled)
    ...
    def retranslateUi(self, ModelFinder):
        ...
        self.radioButton.setToolTip(_translate("ModelFinder", "edge-linked equal partition model"))
        self.radioButton.setText(_translate("ModelFinder", "Edge-linked equal"))
        self.radioButton_3.setToolTip(_translate("ModelFinder", "Edge-linked proportional partition model"))
        self.radioButton_3.setText(_translate("ModelFinder", "Edge-linked proportion"))
        ...
        self.checkBox_4.setToolTip(_translate("ModelFinder", "select the optimum number of classes and the substitution model in each class for a mixture model of Q matrices"))
        self.checkBox_4.setText(_translate("ModelFinder", "MixtureFinder"))
        ...
        self.comboBox_5.setItemText(8, _translate("ModelFinder", "MCMCtree (NUC)"))
        self.comboBox_5.setItemText(9, _translate("ModelFinder", "MCMCtree (AA)"))
        self.checkBox_2.setText(_translate("ModelFinder", "FreeRate heterogeneity [+R]"))
        self.spinBox_2.setPrefix(_translate("ModelFinder", "Min category: "))
        self.spinBox_3.setPrefix(_translate("ModelFinder", "Max category: "))
