...
class Ui_Matrix(object):
    def setupUi(self, Matrix):
        ...
        self.gridLayout.addWidget(self.spinBox_7, 0, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_color, 1, 6, 1, 1)
        ...
        self.verticalLayout_2.addWidget(self.groupBox_top_line)
