...
# Form implementation generated from reading ui file 'F:\Work\python\bioinfo_excercise\PhyloSuite\PhyloSuite\PhyloSuite\uifiles\partition_defination.ui'
#
...
class Ui_PartDefine(object):
    def setupUi(self, PartDefine):
        ...
        self.tableView_partition = QtWidgets.QTableView(self.widget)
        ...
        self.pushButton_adp = QtWidgets.QPushButton(self.widget)
        icon2 = QtGui.QIcon()
        ...
        self.pushButton_delp = QtWidgets.QPushButton(self.widget)
    ...
    def retranslateUi(self, PartDefine):
        ...
        PartDefine.setWindowTitle(_translate("PartDefine", "Partition definations"))
        self.label.setText(_translate("PartDefine", "Specify the data blocks:"))
