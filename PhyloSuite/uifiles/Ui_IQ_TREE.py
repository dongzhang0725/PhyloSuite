...
# Form implementation generated from reading ui file 'E:\F\Work\python\bioinfo_excercise\PhyloSuite\codes\PhyloSuite_gitee\PhyloSuite\uifiles\IQ_TREE.ui'
#
...
class Ui_IQTREE(object):
    def setupUi(self, IQTREE):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1134, 678))
        ...
        self.gridLayout_4.addWidget(self.label_27, 0, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.comboBox_6, 0, 4, 1, 2)
        self.checkBox_9 = QtWidgets.QCheckBox(self.groupBox_4)
        self.checkBox_9.setChecked(True)
        self.checkBox_9.setObjectName("checkBox_9")
        self.gridLayout_4.addWidget(self.checkBox_9, 1, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.lineEdit_2, 2, 2, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.comboBox_10, 1, 2, 1, 4)
        ...
        self.spinBox_2.setProperty("value", 98)
        ...
        self.gridLayout_3.addWidget(self.checkBox_7, 0, 5, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.checkBox_6, 1, 4, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.spinBox_5, 1, 5, 1, 1)
        ...
        self.checkBox_11.toggled['bool'].connect(self.spinBox_2.setEnabled)
    ...
    def retranslateUi(self, IQTREE):
        ...
        self.lineEdit_2.setPlaceholderText(_translate("IQTREE", "Optional! (in newick format)"))
        self.label_6.setText(_translate("IQTREE", "Start tree:"))
        self.checkBox_11.setText(_translate("IQTREE", "Trimming alignment sites by likelihood"))
        self.spinBox_2.setSuffix(_translate("IQTREE", "% of sites"))
        self.spinBox_2.setPrefix(_translate("IQTREE", "retain "))
