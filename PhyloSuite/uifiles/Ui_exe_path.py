...
# Form implementation generated from reading ui file 'F:\Work\python\bioinfo_excercise\PhyloSuite\PhyloSuite\PhyloSuite\uifiles\exe_path.ui'
#
...
class Ui_ExePath(object):
    def setupUi(self, ExePath):
        ...
        ExePath.resize(410, 268)
        ExePath.setMinimumSize(QtCore.QSize(410, 0))
        ExePath.setMaximumSize(QtCore.QSize(410, 16777215))
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(ExePath)
